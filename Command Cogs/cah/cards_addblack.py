...
def setup(Bot):
    ...
    Bot.command_info.update({"cards_addblack":{
        "aliases":["cards_addblack", "addblack"],
        "syntax":"[black card]",
    ...
    @commands.command(name="cards_addblack", aliases=["addblack"])
    async def _cards_addblack(ctx, *, black_card):
    ...
    Bot.add_command(_cards_addblack)