...
def setup(Bot):
    ...
    async def _geoforecast(ctx):
        ...
        geo_embed.add_field(name="Info:", value="The Kp index is a measure of the disturbances in the earth's magnetic field caused by solar winds. The range goes from 0, representing very little activity, to 9, being an intense geomagnetic storm; think [The Carrington Event](https://en.wikipedia.org/wiki/Carrington_Event).")
