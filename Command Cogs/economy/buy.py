        ...
        for key, value in item_json.items():
            if item_name.lower() == value["display_name"].lower():
                ...
                if msg.content.lower() in ["yes please", "yes", "ye", "yep", "yeah", "confirm", "affirmative", "true"]:
                    ...
                    bought_embed = general_utils.format_embed(ctx.author, discord.Embed(title=f"Bought {amount} {general_utils.item_plural(value, amount)} from the {shops_json[value['purchasable']]['display_name']}"))
